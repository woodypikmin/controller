...
// taps, swipes, and the fixed 12-pink-Pikmin selection batch.
...
async fn run_command(
    ...
    Ok(format!(
        "PHONE-LOCAL XCTEST COMMAND COMPLETED • command={} • p1=({:.5},{:.5}) • p2=({:.5},{:.5}) • duration={:.3} • runner={} • pid={} • target={}",
        command, x1, y1, x2, y2, duration, runner_id, pid, target_id
    ))
}
