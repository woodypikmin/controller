...
struct ContentView: View {
            ...
            List {
                Section {
                    VStack(alignment: .leading, spacing: 7) {
                        ...
                        Text("Stage 7.3 — Phone-local CoreDevice HID")
                            .font(.headline)
                ...
                Section("Bot Core") {
                    ...
                    Label("Stage 7.3：UniversalHID tap/swipe probe", systemImage: "hand.tap.fill")
    ...
    @MainActor private func takeScreenshot() async {
        ...
        let outputURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("PikminPilot-Stage7.3-Screenshot.png")
