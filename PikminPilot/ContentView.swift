            ...
            List {
                Section {
                    VStack(alignment: .leading, spacing: 7) {
                        ...
                        Text("Stage 7.7 — Phone-local XCUITest Runner Launch")
                            .font(.headline)
                ...
                Section("Stage 7.7 測試順序") {
                    Text("1. Runner 已經 FOUND 的話，不需要重新安裝 Runner；只更新 Stage 7.7 主 App 即可。\n2. 開 LocalDevVPN。\n3. CONNECT PHONE-LOCAL RSD。\n4. 按 PHONE-LOCAL → LAUNCH XCTEST RUNNER。\n5. 成功應顯示 PHONE-LOCAL XCTEST RUNNER LAUNCH SENT • <bundle id>。\n6. 畫面可能短暫切到 Runner、顯示測試 Runner 畫面，或 Runner 很快退出；這一版重點是 AppService 接受並啟動 .xctrunner。\n7. 把狀態文字和你看到的畫面反應告訴我。")
                }
                ...
                Section("Bot Core") {
                    ...
                    Label("Stage 7.7：phone-local .xctrunner process launch", systemImage: "play.circle.fill")
                }
            }
